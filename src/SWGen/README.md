The purpose of SWGen is to have a static website generator where both the metadata and the front-end generation logic is written in a typed language like C#.
